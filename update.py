...
def main():
    ...
    url = "https://api.papermc.io/v2/projects/paper/versions/1.20.1/builds"
    ...
    url = (f"https://api.papermc.io/v2/projects/paper/versions/1.20.1/builds/{last_build.build}/downloads/"
